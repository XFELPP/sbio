...
<Tabs>
  <TabItem label="Linux" icon="linux">
    <Steps>
      1. Built against `ncarray == 0.7.2`
      2. MPI Support with `MPICH 5.0.1`
      3. XTC2 Data Format Support
      4. Python Wheels for Python 3.8-3.13
    </Steps>
  </TabItem>
  <TabItem label="Windows" icon="seti:windows">
    <Steps>
      1. Built against `ncarray == 0.7.2`
      2. MPI support with `MS-MPI 10.1.1`
      3. XTC2 Data Format Support
      4. Python Wheels for Python 3.8-3.13
    </Steps>
  </TabItem>
